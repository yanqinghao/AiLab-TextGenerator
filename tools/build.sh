...
docker build -t registry-vpc.cn-shanghai.aliyuncs.com/shuzhi/pytorch-stream-gpu:$1 -f docker/stream_yanqing_gpu/Dockerfile .
...
docker build -t registry-vpc.cn-shanghai.aliyuncs.com/shuzhi/pytorch-stream:$1 -f docker/stream_yanqing/Dockerfile .
sed -i "s/cu100/cpu/g" .dockerignore

docker push registry-vpc.cn-shanghai.aliyuncs.com/shuzhi/pytorch-docker:$1
docker push registry-vpc.cn-shanghai.aliyuncs.com/shuzhi/pytorch-stream:$1
docker push registry-vpc.cn-shanghai.aliyuncs.com/shuzhi/pytorch-docker-gpu:$1
docker push registry-vpc.cn-shanghai.aliyuncs.com/shuzhi/pytorch-stream-gpu:$1